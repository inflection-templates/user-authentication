...
import { UserDeviceDetailsDomainModel, UserDeviceDetailsSearchFilters } from '../../../domain.types/users/user.device.details.types';
...
export class UserDeviceDetailsValidator {
    ...
    static getDomainModel = (request: express.Request): UserDeviceDetailsDomainModel => {
        ...
        const model: UserDeviceDetailsDomainModel = {
