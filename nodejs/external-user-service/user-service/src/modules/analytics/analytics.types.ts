...
export enum AnalyticsEventType {
    ...
    UserSendPasswordResetLink     = "user-send-password-reset-link",
    UserSendPasswordResetPhoneOtp = "user-send-password-reset-phone-otp",
    UserSendPasswordResetEmailOtp = "user-send-password-reset-email-otp",
