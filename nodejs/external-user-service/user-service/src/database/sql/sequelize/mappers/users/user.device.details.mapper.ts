import { UserDeviceDetailsDto } from '../../../../../domain.types/users/user.device.details.types';
import UserDeviceDetailsModel from '../../models/users/user.device.details.model';
